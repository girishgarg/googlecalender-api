...
public class Mail {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String to = "girishgarg258@gmail.com";        
        String from = "girish@eze.ai";        
        String subject = "Allow access to your calender";        
        String bodyText = "click on the link http://localhost/googlecontactapi/test.html";
